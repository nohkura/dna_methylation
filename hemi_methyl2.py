#!/user/skg-lab/nohkura/anaconda3/bin/python
# -*- coding: utf-8 -*-
# @Author: yyasumizu
# @Date: 2019-03-15
...
parser.add_argument('-p', '--path', default='/user/skg-lab/nohkura/Programs/dna_methylation/methyl_diff/methyl_diff', help='path to methyl_diff')
...
df = pd.read_csv(f_pos, sep="\t", header=0)
df.columns=['chr', 'start', 'end', 'P_me', 'P_de', 'P_low', 'P_ratio', 'P_high']

df2= pd.read_csv(f_neg, sep="\t", header=0)
